...
/**
 * La clase Vestibulo representa la interfaz gráfica principal de la aplicación.
 */
public class Vestibulo extends JFrame {
    ...
    /**
     * Constructor de la clase que crea el frame del Vestíbulo.
     */
    public Vestibulo() {
        setResizable(false);
        ...
        lblNewLabel_1.setIcon(new ImageIcon("C:\\Ruta\\A\\Tus\\Imágenes\\Aquí\\productos.png"));
        ...
        // Sección para mostrar otro tipo de productos
        ...
        lblNewLabel_1_1.setIcon(new ImageIcon("C:\\Ruta\\A\\Tus\\Imágenes\\Aquí\\otroproducto.png"));
        ...
        // Sección para mostrar más productos
        JLabel lblNewLabel_1_2 = new JLabel("");
        lblNewLabel_1_2.setIcon(new ImageIcon("C:\\Ruta\\A\\Tus\\Imágenes\\Aquí\\masproductos.png"));
        lblNewLabel_1_2.setFont(new Font("Tahoma", Font.PLAIN, 33));
        lblNewLabel_1_2.setBounds(658, 39, 162, 184);
        panel.add(lblNewLabel_1_2);

        JLabel lblNewLabel_2_2 = new JLabel("Más Productos");
