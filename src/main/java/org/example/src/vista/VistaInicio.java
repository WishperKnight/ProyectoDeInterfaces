...
public class VistaInicio extends JFrame {
	...
	public VistaInicio() {
		...
		contentPane.add(btnCrearCuenta);
				...
				//JPopupMenu menuContextual que contendra los JMenuItem menuItemIniciarSesion, menuItemCrearCuenta y menuItemUsuarioInvitado y al que podremos acceder haciendo click derecho
				JPopupMenu menuContextual = new JPopupMenu();
				
				//JMenuItem menuItemIniciarSesion con el que nos dirigiremos a la ventana de inicio de sesion
				...
				//JMenuItem menuItemCrearCuenta con el que nos dirigiremos a la ventana de creacion de cuenta
				...
				//JMenuItem menuItemUsuarioInvitado con el que podremos acceder a la ventana principal usando un usuario invitado
		...
		//Boton btnUsuarioInvitado para acceder a la ventana principal usando un usuario invitado		
		...
		//JTextArea textAreaTextoDescriptivo que mostrara un texto descriptivo de la aplicacion
		...
		//JMenuItem menuItemSesionIniciar con el que podremos iniciar sesion con una cuenta ya creada
		...
		//JMenuItem menuItemInvitadoAcceder con el que podremos iniciar sesion con una cuenta ya creada
