...
public class VistaLogin extends JFrame {
	...
	public VistaLogin() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(VistaLogin.class.getResource("/assets/imagenes/logoMercadona.png")));
		setResizable(false);
		...
		// Etiqueta que al principio sera invisible, pero en caso de error a la hora de
		// insertar las credenciales mostrara un mensaje
		lbError = new JLabel("");
		...
		btnIniciarSesion
				.setIcon(new ImageIcon(VistaLogin.class.getResource("/assets/imagenes/iniciarSesionImagenBoton.png")));
		...
		// JMenuItem menuItemVolverAtras con el que podremos volver a la ventana
		// anterior
		...
		// JMenuItem menuItemReproducirAudio con el que podremos reproducir el audio de
		// ayuda
		...
		// JMenuItem menuItemVolver con el que iniciaremos sesion con los datos
		// introducidos
		JMenuItem menuItemSesionIniciar = new JMenuItem("Iniciar sesion");
		menuItemSesionIniciar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				controlador.iniciarSesion();
			}
		});
		menuItemSesionIniciar.setAction(action);
