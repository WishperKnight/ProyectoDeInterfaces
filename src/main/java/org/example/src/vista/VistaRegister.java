...
public class VistaRegister extends JFrame {
	...
	public VistaRegister() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(VistaRegister.class.getResource("/assets/imagenes/logoMercadona.png")));
		...
		// Boton btnCrearCuenta con el que crearemos la cuenta con los datos
		// establecidos
		...
		// JPopupMenu menuContextual que contendra los JMenuItem menuItemRegistrarse,
		// menuItemVolverAtras y menuItemReproducirAudio los cuales podremos acceder
		// haciendo click derecho
		JPopupMenu menuContextual = new JPopupMenu();

		// JMenuItem menuItemRegistrarse con el que estableceremos la cunta nueva con
		...
		// jlabel lbApellidosRequerido para indicar que el textfield tfApellidos es
		// requerido
		...
		// jlabel lbDireccionRequerido para indicar que el textfield tfDireccionEnvio es
		// requerido
		...
		// jlabel lbContraseniaRequerido para indicar que el textfield tfContrasenia es
		// requerido
		...
		// JMenuItem menuItemCuentaEstablecer con el que estableceremos la cuenta con
		// los datos que he introducido
		...
		// JMenuItem menuItemAudioReproducir con el que podremos reproducir el audio de
		// ayuda
	...
	/**
	 * metodo que te da un nombre de usario
	 */
